                  ...
                  <v-card flat tile class="card">
                    ...
                    <div class="d-flex flex-wrap justify-space-between" id="btns">
                      ...
                      <v-card-actions class="pt-0 pl-0">
                        <v-btn text @click="createFeeling('like')"><v-icon :class="`pr-2${feeling !== 'like'
                          ? ' grey--text text--darken-1'
                          : ''
                          }`
                          ">mdi-thumb-up</v-icon>{{ video.likes }}</v-btn>

                        <v-btn text @click="createFeeling('dislike')"><v-icon :class="`pr-2${feeling !== 'dislike'
                          ? ' grey--text text--darken-1'
                          : ''
                          }`
                          ">mdi-thumb-down</v-icon>
                          {{ video.dislikes }}</v-btn>
                        <v-btn :href="`${url}/uploads/videos/${video.url}`" text
                          class="grey--text text--darken-1"><v-icon>mdi-download</v-icon> Download</v-btn>
                  ...
                  <v-row class="justify-space-between">
                      ...
                      <v-card class="transparent" flat>
                        <v-list-item three-line>
                          <v-list-item-avatar v-if="typeof video.userId !== 'undefined'" size="50">
                            <img v-if="video.userId.photoUrl !== 'no-photo.jpg'" :src="`${getUrl}/uploads/avatars/${video.userId.photoUrl}`
                          ...
                          <v-list-item-content v-if="video.userId" class="align-self-auto">
                            <v-list-item-title class="font-weight-medium mb-1">{{ video.userId.channelName
                            }}</v-list-item-title>
                            <v-list-item-subtitle>{{ video.userId.subscribers }} subscribers
                    ...
                    <v-col cols="12" sm="6" md="4" lg="4">
                      <div class="d-flex justify-end align-center" v-if="typeof video.userId !== 'undefined'">
                        <v-btn v-if="currentUser && video.userId._id !== currentUser._id
                          " :class="[
                  ...
                  <v-card class="card" tile flat v-if="!loading" :to="`/watch/${video._id}`">
                    <v-row no-gutters>
                      <v-col class="mx-auto" cols="12" sm="12" md="5" lg="5">
                        ...
                        <v-img class="align-center" style="max-height:180px; max-width: 320px;" :src="`${url}/uploads/thumbnails/${video.thumbnailUrl}`
                          ">
                        </v-img>
                        <!-- </v-responsive> -->
                      </v-col>
